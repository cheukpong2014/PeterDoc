...
{
    public partial class exportByReceiptDate : eClaimModuleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    //    var allForms = new ClaimFormController().GetClaimFormByRegionAndStatus(regions).Select(az => new newList
                    //    {
                    //        ID = az.ID.ToString(),
                    //        Region = az.Region,
