...
//4 State
//有state, previousState
//setInterval 之後唔太明，唔明點解要有previousState => (
import React, { Component } from 'react';
import { AppRegistry, Text, View } from 'react-native';
...
//6 Height and Width
//width, height, backgroundColor, 留意style={{}}
import React, { Component } from 'react';
...
//唔明，{this.state.text.split(' ').map((word) => word && '🍕').join(' ')}
import React, { Component } from 'react';
